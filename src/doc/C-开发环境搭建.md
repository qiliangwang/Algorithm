...
比如解压把到下面的文件目录，安装CLion的时候选择下面的路径即可，接着激活CLion。

F:\Users\Vader\Documents\x86_64-8.1.0-release-posix-seh-rt_v6-rev0\mingw64

PS：在windows上，解压到 C:\Program Files 目录下CLion会自动识别。
