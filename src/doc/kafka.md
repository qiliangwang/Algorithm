...
```
Mar 05, 2019 1:46:08 PM com.github.shyiko.mysql.binlog.BinaryLogClient connect
INFO: Connected to 127.0.0.1:3306 at mysql-bin.000001/2086 (sid:65535, cid:11)
Write---------------
WriteRowsEventData{tableId=110, includedColumns={0, 1, 2, 3, 4, 5, 6, 7, 8}, rows=[
    [4, insert, , 1, , 1, 1, Thu Jan 01 08:00:00 CST 1970, Thu Jan 01 08:00:00 CST 1970]
]}
Update--------------
UpdateRowsEventData{tableId=110, includedColumnsBeforeUpdate={0, 1, 2, 3, 4, 5, 6, 7, 8}, includedColumns={0, 1, 2, 3, 4, 5, 6, 7, 8}, rows=[
    {before=[4, insert, , 1, , 1, 1, Thu Jan 01 08:00:00 CST 1970, Thu Jan 01 08:00:00 CST 1970], after=[4, insert, code, 1, , 1, 1, Thu Jan 01 08:00:00 CST 1970, Thu Jan 01 08:00:00 CST 1970]}
]}
Delete--------------
DeleteRowsEventData{tableId=110, includedColumns={0, 1, 2, 3, 4, 5, 6, 7, 8}, rows=[
    [3, jkl;, jkd, 1, , 1, 1, Thu Jan 01 08:00:00 CST 1970, Thu Jan 01 08:00:00 CST 1970]
]}
...
$ bin/kafka-console-consumer.sh --zookeeper localhost:2181 --topic topic_app_startup
...
export FLUME_HOME=/home/vaderwang/software/apache-flume
export PATH=$FLUME_HOME/bin:$PATH


$ flume-ng agent -f flume-conf.properties -n a1

$ hive> add jar /home/vaderwang/software/apache-hive-2.1.1-bin/lib/app_logs_hive.jar;

$ hive> add jar /home/vaderwang/Desktop/Hive-JSON-Serde/json-serde/target/json-serde-1.3.9-SNAPSHOT-jar-with-dependencies.jar;
