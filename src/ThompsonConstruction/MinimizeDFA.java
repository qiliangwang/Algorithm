...
public class MinimizeDFA {
	...
	DfaConstructor dfaCounstructor = null;
	...
	public MinimizeDFA(DfaConstructor dfaCounstructor) {
		this.dfaCounstructor = dfaCounstructor;	
        dfaList = dfaCounstructor.getDfaList();
        dfaTransTable = dfaCounstructor.getDfaStateTransformTable();
	}
